...
# detrended_retFut1 = detrendPrice.detrendPrice(df_test.retFut1).fillna(0)
...
for selectors: 
mutual information classifiers can measure nonlinear dependence between variables 
phi_k can also capture non linear information

for scorer: 
only phi_k is used for nonlinear, generally Rsquared is reserved for linear applications
"""