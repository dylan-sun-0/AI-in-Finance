...
# inspect_me = preprocessor.fit_transform(x_train.values)
# print(inspect_me.shape[1])
# for col_index in range(inspect_me.shape[1]):
#     unique_values = np.unique(inspect_me[:, col_index])
#     print(col_index, unique_values)
