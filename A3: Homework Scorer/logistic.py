...
plt.tight_layout()
#plt.show()
plt.savefig(r'%s.png' %("Correlation Matrix"))
...
plt.tight_layout()
#plt.show()
plt.savefig(r'%s.png' %("Correlation Matrix Significance"))
...
plt.tight_layout()
#plt.show()
plt.savefig(r'%s.png' %("Global Correlations"))
...
plot_correlation_matrix(zvalues, x_labels=xlabels, y_labels=ylabels, 
                        ...
                        figsize=(7, 5))
#plt.show()
plt.savefig(r'%s.png' %("Outlier Significance Matrix for Hour"))
...
#plt.show()
plt.savefig(r'%s.png' %("Outlier Significance Matrix for Day"))
...
c_rs = np.logspace(3, -4, 20, endpoint=True)
...
plt.xlabel('Date')
#plt.show()
plt.savefig(r'%s.png' %("TrainCumulative"))
...
plt.xlabel('Date')
#plt.show()
plt.savefig(r'%s.png' %("TestCumulative2"))
...
plt.tight_layout()
#plt.show()
plt.savefig(r'%s.png' %("Significance2"))
...
fig.tight_layout();
#plt.show()
plt.savefig(r'%s.png' %("Residuals2"))
plt.close("all")
...
we need not multiply the coefficients 
...
#plt.show()
plt.savefig(r'%s.png' %("Coefficients2"))
