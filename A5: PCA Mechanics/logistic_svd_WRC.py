...
pipe = Pipeline(steps=[('svd', TruncatedSVD()),('preprocessor', preprocessor),('logistic', logistic)])
pipe = Pipeline(steps=[('preprocessor', preprocessor),('logistic', logistic),('svd', TruncatedSVD())])
