...
"""
"""
Here you will learn how to use a feature extraction device (sklearn.decomposition.PCA)
for feature extraction or
for feature denoising.
Scikit-learn by default does feature extraction with PCA.
We just want you to realize that this is what is going on (by default), and
how to change it if required.
...
To make PCA()in the pipeline to do feature reconstruction, requires a CustomPCA() (with inverse_transform(self.pca.fit_transform(X))).
